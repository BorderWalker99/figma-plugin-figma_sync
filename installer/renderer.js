...
const i18n = {
  zh: {
    welcome_subtitle: '选择语言后点击开始，按步骤完成安装',
    ...
    btn_copy: '一键复制',
    step2_title: '确认安装包可用',
    step2_desc: '安装器将检查所需组件是否可用',
    step3_title: '准备运行环境',
    step3_desc: '此过程可能需要数分钟，请保持窗口打开',
    step3_ready_bundled: '内置运行环境已准备完成',
    step3_ready_generic: '运行环境已准备完成',
    step4_title: '设置本地工作区',
    step4_desc: '选择本地同步文件夹，安装器将保存语言与同步配置',
    step4_result_folder: '已准备本地文件夹',
    step4_result_settings: '语言与同步设置已保存',
    step5_title: '完成系统授权',
    step5_desc: '完成授权后请返回安装器',
    ...
    step6_detail_success: '服务已在后台运行，可关闭本窗口',
  ...
  en: {
    welcome_subtitle: 'Select your language and click Start, then follow the steps',
    ...
    step2_desc: 'The installer will verify that required components are available',
    step3_title: 'Prepare the runtime',
    step3_desc: 'This may take a few minutes. Please keep the window open',
    step3_ready_bundled: 'Bundled runtime is ready',
    step3_ready_generic: 'Runtime is ready',
    step4_title: 'Set up your workspace',
    step4_desc: 'Select your local sync folder; the installer will save language and sync settings',
    step4_result_folder: 'Local folder is ready',
    step4_result_settings: 'Language and sync settings saved',
    step5_title: 'Complete Security Approval',
    step5_desc: 'Please return to the installer when done',
    ...
    step6_detail_starting: 'Finishing setup, please wait',
    step6_detail_success: 'The service is running in the background. You may close this window',
    step6_detail_error: 'Please review the error details',
