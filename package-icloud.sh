...
# ScreenSync iCloud 版本用户分发打包脚本
# 此脚本会打包一个专门用于 iCloud 模式的安装包
...
echo -e "${BLUE}╔════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║  ScreenSync iCloud 版本打包脚本        ║${NC}"
echo -e "${BLUE}║  支持文件自动分类和选择性清理          ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════╝${NC}\n"
...
echo -e "${GREEN}📦 开始打包 iCloud 版本...${NC}\n"
...
cp icloud-watcher.js "$TEMP_DIR/项目文件/"  # 关键：包含 iCloud watcher
...
echo "╔════════════════════════════════════════════════════════╗"
echo "║                                                        ║"
echo "║       ScreenSync 安全修复工具 (iCloud 版本)            ║"
echo "║                                                        ║"
echo "╚════════════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "💡 iCloud 模式使用提示："
echo "   1. 安装后默认为 Google Cloud 模式"
echo "   2. 切换到 iCloud 模式的方法（彩蛋）："
echo "      - 打开插件设置页面"
echo "      - 按 F12 打开开发者工具"
echo "      - 在控制台中输入："
echo "        document.getElementById('modeSwitchSection').style.display='block';"
echo "        document.getElementById('switchToIcloud').style.display='flex';"
echo "      - 然后点击 iCloud 图标切换模式"
echo ""
read -p "按回车键关闭此窗口..."
SCRIPT_EOF
...
此安装包是 iCloud 特别版，适用于 Apple 芯片 Mac (M1/M2/M3/M4)。
包含 iCloud 模式支持，可以使用 iCloud 云盘同步截图。
...
默认安装后是 Google Cloud 模式。如需切换到 iCloud 模式：
...
4. 在控制台中输入以下代码并按回车：
   ...
   document.getElementById('modeSwitchSection').style.display='block';
   document.getElementById('switchToIcloud').style.display='flex';

5. 现在可以看到云服务选择区域，点击 iCloud 图标切换
...
ScreenSync - iPhone截图自动同步到Figma (iCloud 特别版)
...
ScreenSync 用户分发包 (iCloud 特别版)
版本: ${VERSION}
打包日期: $(date +"%Y-%m-%d %H:%M:%S")
特性: 支持 iCloud 模式、文件自动分类、选择性清理
EOF
...
echo ""
echo -e "${YELLOW}📋 iCloud 版本特性：${NC}"
echo -e "   - 包含 icloud-watcher.js 支持 iCloud 模式"
echo -e "   - 文件自动分类到子文件夹（图片/视频/GIF/导出的GIF）"
echo -e "   - 支持选择性清理（根据备份设置）"
echo -e "   - 模式切换作为彩蛋功能，通过控制台显示"
echo ""
echo -e "${BLUE}💡 使用说明：${NC}"
echo -e "   1. 解压后默认是 Google Cloud 模式"
echo -e "   2. 切换到 iCloud 模式需要在插件设置中使用彩蛋功能"
