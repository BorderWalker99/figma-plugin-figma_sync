...
async function listFolderFiles({ folderId, pageSize = 50, orderBy = 'createdTime desc', fields = 'files(id,name,mimeType,createdTime,modifiedTime,size,parents),nextPageToken', supportsAllDrives = true }) {
  if (!folderId || folderId.trim() === '' || folderId === '.') {
