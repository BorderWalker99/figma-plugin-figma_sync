...
echo -e "${BLUE}║  2. 双击 ScreenSync Installer.app 运行安装器              ║${NC}"
echo -e "${BLUE}║  3. 按照图形界面完成安装                                   ║${NC}"
echo -e "${BLUE}║  4. 在 Figma 中导入插件：                                  ║${NC}"
echo -e "${BLUE}║     Plugins → Development → Import plugin from manifest   ║${NC}"
echo -e "${BLUE}║  5. 选择：{安装目录}/figma-plugin/manifest.json            ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}\n"
