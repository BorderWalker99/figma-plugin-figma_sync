...
if [ -f "安装前:将此文件拖进终端按回车运行.command" ]; then
    cp "安装前:将此文件拖进终端按回车运行.command" "$TEMP_DIR/"
    chmod +x "$TEMP_DIR/安装前:将此文件拖进终端按回车运行.command"
    echo "   ✅ Gatekeeper 修复脚本已包含（首层目录）"
fi

# 复制手动连接脚本（放在首层）
if [ -f "若连接断开:将此文件拖进终端按回车运行.command" ]; then
    cp "若连接断开:将此文件拖进终端按回车运行.command" "$TEMP_DIR/"
    chmod +x "$TEMP_DIR/若连接断开:将此文件拖进终端按回车运行.command"
    echo "   ✅ 手动连接脚本已包含（首层目录）"
fi
...
2. 将文件"安装前:将此文件拖进终端按回车运行.command"拖入终端窗口
3. 按回车键运行
4. 看到"✅ 准备完成！"后关闭终端
...
echo "   ✅ 安装前:将此文件拖进终端按回车运行.command（Gatekeeper 修复）"
echo "   ✅ ScreenSync Installer.app（图形化安装器）"
echo "   ✅ 若连接断开:将此文件拖进终端按回车运行.command（备用连接方案）"
echo ""
...
echo -e "${BLUE}║     或将"若连接断开:将此文件..."拖入终端并回车             ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}\n"
